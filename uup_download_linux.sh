#!/bin/bash
#Generated on 2020-10-31 15:12:27 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.ml/get.php?id=d7fd9714-73c5-4490-883b-80c425c32891&pack=zh-cn&edition=professional&aria2=2"
if [ $? != 0 ]; then
